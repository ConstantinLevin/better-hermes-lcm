...
class ReconcileMixin:
    ...
    def _reconcile_ingest_cursor_from_store(self, messages: List[Dict[str, Any]]) -> int:
        ...
        stored_head_rows = [
            ...
            # fork: better-hermes-lcm — an archived correction is appended at the END of the archive; it
    ...
    def _get_store_id_map_for_messages(self, messages: List[Dict[str, Any]]) -> dict[int, int]:
        ...
        # fork: better-hermes-lcm — a message the host EDITED no longer matches the row it was first
