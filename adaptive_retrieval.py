...
class RetrievalRound:
    ...
    # fork: better-hermeslcm — why the round was incomplete, when the TOOL said so (verify-4 #21)
    ...
    def search(
        ...
        *,
        ...
        with self._lock:
            ...
            # fork: better-hermeslcm — the TOOL's own incompleteness counts as truncation of this
