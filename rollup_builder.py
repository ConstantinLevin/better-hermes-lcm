...
class RollupSourcesUnavailable(RuntimeError):
    """fork: better-hermeslcm — the summary database could not be read for this scope.
    ...
    *,
    ...
    while True:
        ...
        if summary_tokens >= previous_tokens:
            # fork: better-hermeslcm — never truncate. A rollup that cannot be shrunk below its cap
