...
# this module logged through a name it never imported, so the one handler
...
def _temporary_sqlite_busy_timeout(
    ...
    # if SETUP fails partway, the connections already changed keep the short
...
def _restore_sqlite_busy_timeouts(
    ...
    """restore every connection, even if one of them refuses."""
