...
def _call_structured_assertion_llm(
    ...
    # fork: better-hermes-lcm — a truncated generation is not a payload (round-3 verify-4 #27)
    ...
    # fork: better-hermes-lcm — a JSON payload is parsed UNTOUCHED. Stripping reasoning blocks first
