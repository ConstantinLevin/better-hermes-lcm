...
class LCMPreset:
    ...
    fork: better-hermes-lcm — presets are documentation of the two curve anchors: every window-
...
def suggest_preset_for_engine(engine: Any) -> tuple[LCMPreset | None, str]:
    ...
    # fork: better-hermes-lcm — from 512k up the window-scaled defaults (window_scaling.py) are the
