...
class LCMPreset:
    ...
    fork: better-hermeslcm — presets are documentation of the two curve anchors: every window-
...
def suggest_preset_for_engine(engine: Any) -> tuple[LCMPreset | None, str]:
    ...
    # fork: better-hermeslcm — from 512k up the window-scaled defaults (window_scaling.py) are the
