...
def test_answer_ready_delta_refs_match_every_hit_the_limit_allowed(
    ...
    # this asserted that hits were evicted to fit a response char cap
...
def test_answer_ready_keeps_every_summary_lead_and_reports_no_delta_refs(
    ...
    # this asserted summary leads were evicted to fit a response char
...
def test_answer_ready_expands_only_first_eight_and_reports_policy(
    ...
    # response_char_cap is gone from the payload with the cap itself
...
def test_answer_ready_echoes_a_huge_query_back_whole(
    ...
    # this asserted the response was held under 64,000 chars and that
