"""fork: better-hermes-lcm — nothing may be lost before the summariser sees it, and when a route does
...
def test_an_extraction_note_names_the_rows_it_came_from(tmp_path, monkeypatch):
    ...
    # fork: better-hermes-lcm — contiguous ids collapse into a range so the COMPLETE manifest fits on
