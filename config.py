...
# levers that are not levers. Each of these can only be switched into a
...
class LCMConfig:
    ...
    #
    # this is not a setting any more. Upstream writes an oversized tool
    ...
    # RETIRED, always off. Replaces textual tool results with durable
    ...
    # keep a DURABLE copy of an oversized tool result that the host wrote to
    ...
    # ── window-weighted tuning (see window_scaling.py) ──────────────
    ...
    # 0 = NO ceiling (upstream's literal was 12000). A summary whose size
