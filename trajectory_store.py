...
class TrajectoryStore:
    ...
    def __init__(
        ...
        *,
        ...
        # fork: better-hermes-lcm — LOSSLESS by default. Redaction here is irreversible: two ingests
    ...
    def insert(self, source: TrajectorySource) -> TrajectoryInsertResult:
        ...
        with self._lock:
            ...
            try:
                ...
                self._conn.commit()
            except BaseException:  # fork: better-hermes-lcm — round-2 verify-5 #5
                self._conn.rollback()
                raise
        return TrajectoryInsertResult(
            trajectory_id=trajectory_id,
    ...
    def _semantic_documents(self) -> list[tuple[int, str, str]]:
        ...
        for source in sources:
            ...
            # fork: better-hermes-lcm — the STORE is lossless (protect_sensitive defaults to False),
