...
class TrajectoryStore:
    ...
    def __init__(
        ...
        *,
        ...
        # LOSSLESS by default. Redaction here is irreversible: two ingests
    ...
    def insert(self, source: TrajectorySource) -> TrajectoryInsertResult:
        ...
        with self._lock:
            ...
            try:
                ...
                self._conn.commit()
            except BaseException:  # round-2 verify-5 #5
                self._conn.rollback()
                raise
        return TrajectoryInsertResult(
            trajectory_id=trajectory_id,
    ...
    def _semantic_documents(self) -> list[tuple[int, str, str]]:
        ...
        for source in sources:
            ...
            # the STORE is lossless (protect_sensitive defaults to False),
